...
uses
  ...
  UDM_3LM, UFuncionarioDAO, UFuncionarioModel, Vcl.Mask, UFuncoesDAO, UFuncoesModel, Vcl.DBCtrls, UCadastroFuncoes;
...
type
  TfrmCadastroFuncionario = class(TfrmPrincipal)
    ...
    btnMudarCadastroFuncoes: TButton;
    ...
    procedure btnMudarCadastroFuncoesClick(Sender: TObject);
  private
...
procedure TfrmCadastroFuncionario.btnMudarCadastroFuncoesClick(Sender: TObject);
var
  atualizarGrid: TFuncionarioDAO;
begin
  inherited;
